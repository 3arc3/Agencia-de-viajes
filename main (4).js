...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (contactForm) {
    contactForm.addEventListener('submit', (e) => {
      ...
      const travelersEl = document.getElementById('cTravelers');
      ...
      if (!nameOk) nameEl.parentElement.querySelector('.field-error')?.classList.add('is-visible');
      ...
      const body =
        ...
        `Nº de viajeros: ${travelersEl.value || 'No indicado'}\n\n` +
